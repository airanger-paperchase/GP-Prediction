...
const Index = () => {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      const upResp = await axios.post<{
        ...
        partial_rows?: any[];
        counts?: any;
      }>(`${API_BASE}/glmapapi/upload/extract_missing`, form, {
      ...
      if (missing.length > 0) {
        ...
        const leResp = await axios.post(`${API_BASE}/glmapapi/batch/langextract_by_company`, leReq);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axios.post(`${API_BASE}/glmapapi/save`, payload, {
  ...
  const handleDownloadCSV = async () => {
    ...
    try {
      ...
      await axios.post(`${API_BASE}/glmapapi/store_auto_mapping`, {
        rows: data.full_dataset || data.rows,
      });
    } catch (e: any) {
      toast({
